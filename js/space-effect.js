(function(window) {
  ...
  if (typeof window.THREE === 'undefined') {
    console.error('THREE is not loaded. Please load Three.js before this script.');
    return;
  }

  // Конструктор SpaceEffect
  ...
  // Экспортируем SpaceEffect в глобальную область видимости
